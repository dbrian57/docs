...
- **[POST /v1/preview/sft-training-jobs](https://docs.wandb.ai/training/api-reference/training-jobs/Create-SFT-Training-Job-v1-preview-sft-training-jobs)** - Create Sft Training Job
- **[POST /v1/preview/training-jobs](https://docs.wandb.ai/training/api-reference/training-jobs/Create-RL-Training-Job-v1-preview-training-jobs)** - Create Rl Training Job
